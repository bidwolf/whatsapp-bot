...
import WhatsappExecutor from './executors/adm.executor.whatsapp';
...
class AdmCommandFactory<ISocketMessage extends IMessage> implements ICommandFactory<ISocketMessage> {
...
export default (
  ...
  const factory = new AdmCommandFactory<WhatsAppMessage>(feedBackSender, logger);
  return factory;
};
